...
- Затем создайте класс инвентаря, который отслеживает различные продукты и может суммировать
стоимость инвентаря.
Программа имитирует поведение реальной системы: необходимо задать исходные данные для
программы в коде.
При проектировании новых классов создайте максимальное количество конструкторов и используйте
их при создании конкретных экземпляров.
